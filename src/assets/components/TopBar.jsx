...
export const TopBar = () => {
    return(
      <div className="flex justify-between items-center gap-4 p-2 shadow-sm">
      ...
      <div>
        <form class="w-96 mx-auto">
          ...
          <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search features,tutorials,etc " required />
          </div>
        </form>
      </div>
      ...
      <div className="flex gap-3">
        <div className='flex h-10 ml-auto mr-4 justify-end gap-4'>
          <div className='rounded-full w-10 bg-gray-300 h-10 flex items-center justify-center'>
